...
function AscensionMod.a7:ShutDoors()
    if AscensionMod.ascensionLevel < 7 then return end
    local room = game:GetRoom()
...
AscensionMod:AddCallback(ModCallbacks.MC_POST_NPC_INIT, AscensionMod.a7.ShutDoors)
...
function AscensionMod.a17:Init()
    AscensionMod.a17.horsePillRNG = RNG(AscensionMod.startSeed, RNG_SHIFT_INDEX)
end
